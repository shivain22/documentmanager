...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './doc-store-access-audit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCSTOREACCESSAUDIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCSTOREACCESSAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCSTOREACCESSAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCSTOREACCESSAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCSTOREACCESSAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCSTOREACCESSAUDIT actions', async () => {
      const expectedActions = [
        {
