...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './doc-col-value-store.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCCOLVALUESTORE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCCOLVALUESTORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCCOLVALUESTORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCCOLVALUESTORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCCOLVALUESTORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCCOLVALUESTORE actions', async () => {
      const expectedActions = [
        {
