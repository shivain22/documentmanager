...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './doc-store.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCSTORE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCSTORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCSTORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCSTORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCSTORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCSTORE actions', async () => {
      const expectedActions = [
        {
