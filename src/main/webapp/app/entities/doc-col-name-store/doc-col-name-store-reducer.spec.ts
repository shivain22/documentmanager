...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './doc-col-name-store.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCCOLNAMESTORE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCCOLNAMESTORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCCOLNAMESTORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCCOLNAMESTORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCCOLNAMESTORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCCOLNAMESTORE actions', async () => {
      const expectedActions = [
        {
